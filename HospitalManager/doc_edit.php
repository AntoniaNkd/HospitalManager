...
<head>
    ...
    $query = "UPDATE doctor SET username='$username', email='$email', phone='$phone', password='$new_password' WHERE id='$id'";
    ...
    echo "<div class= 'btn' style = 'width: 50px;'><a href='doc_edit.php?update={$row['id']}'>{$row['username']}</a></div>";
    echo "<br />";
    }
    ?>
    <?php
    ...
    while ($row = mysqli_fetch_array($data2)) {
        echo "<b><a href='doc_edit.php?update={$row['id']}'>{$row['username']}</a></b>";
        echo "<br />";
    }
    ?>
